// ----------------------------------------------------------------------------
// SAFE SANITIZED FIRMWARE — UI MENU (Non‑operational)
// Purpose: Real‑world jammer CONCEPT study for education (Author: Nafiz Sadik).
// IMPORTANT: EDUCATIONAL PURPOSE ONLY — NO OPERATIONAL JAMMER MATERIAL
// ----------------------------------------------------------------------------
